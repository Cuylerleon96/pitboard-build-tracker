  ...
  builds: [
    {
      ...
      phases: [
        { id: 'phase-scope', name: 'Scope project', owner: '', done: false },
        { id: 'phase-parts', name: 'Plan parts', owner: '', done: false },
        { id: 'phase-fabrication', name: 'Fabrication / install', owner: '', done: false },
        { id: 'phase-testing', name: 'Testing / tune', owner: '', done: false },
      ],
      parts: [],
      pins: [],
      tunes: [],
